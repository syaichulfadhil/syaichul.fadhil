...
df = pd.read_excel (r'C:\Users\Syaichul Fadhil\Desktop\Research Plan\bhisma\GSK\tokpedgsk update.xlsx')
...
dfx = dfx[(dfx['STAT'] == 'Transaksi selesai..Dana akan diteruskan ke penjual.') | (dfx['STAT'] == 'Pesanan telah tiba di tujuan..Dana akan diteruskan ketika barang dikonfirmasi pembeli atau otomatis dalam 48 jam.') | (dfx['STAT'] == 'Pesanan telah dikirim..Pesanan dalam proses pengiriman oleh kurir.')]
...
#promo
detail['PROMOSTAT'] = np.where(detail['CAMPAIGN'] == '-', 'Promo', 'Non-Promo')
...
df3 = df3.fillna(0)
df3['MP'] = 'Tokopedia GSK'

writer = pd.ExcelWriter(r'C:\Users\Syaichul Fadhil\Desktop\Research Plan\bhisma\GSK\TOKPEDGSK - JUL20.xlsx', engine='xlsxwriter')
