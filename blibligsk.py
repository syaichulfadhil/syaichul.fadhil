...
df = pd.read_excel (r'C:\Users\Syaichul Fadhil\Desktop\Research Plan\bhisma\GSK\blibligsk update.xlsx')
...
df1x = dfpv[(dfpv['M'] == 'Jul-20')]
df1 = pd.DataFrame(df1x)
df1 = df1.fillna(0)
...
writer = pd.ExcelWriter(r'C:\Users\Syaichul Fadhil\Desktop\Research Plan\bhisma\GSK\blibliGSK - JUL20.xlsx', engine='xlsxwriter')
